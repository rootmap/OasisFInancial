...
@section("title","Edit Help Case Types Data")
@section("content")
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{url('helpcasetypesdata/list')}}">Datatable </a></li>
      ...
      <div class="col-md-8 offset-2">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Edit / Modify Help Case Types Data</h3>
            <div class="card-tools">
              <ul class="pagination pagination-sm float-right">
                ...
                <li class="page-item">
                    <a class="page-link bg-primary" href="{{url('helpcasetypesdata/list')}}"> 
                        Data 
                        <i class="fas fa-table"></i>
                    </a>
                </li>
                <li class="page-item">
                  <a class="page-link  bg-primary" target="_blank" href="{{url('helpcasetypesdata/export/pdf')}}">
                    <i class="fas fa-file-pdf" data-toggle="tooltip" data-html="true"title="Pdf"></i>
                  </a>
                </li>
                <li class="page-item">
                  <a class="page-link  bg-primary" target="_blank" href="{{url('helpcasetypesdata/export/excel')}}">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form action="{{url('helpcasetypesdata/update/'.$dataRow->id)}}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
                    ...
                    <div class="col-md-6">
                        @if(isset($dataRow->section_image))
                            @if(!empty($dataRow->section_image))
                                <img class="img-thumbnail" src="{{url('upload/helpcasetypesdata/'.$dataRow->section_image)}}" width="150">
                            @endif
                        @endif
                    </div>
                </div>
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-danger" href="{{url('helpcasetypesdata/edit/'.$dataRow->id)}}">
