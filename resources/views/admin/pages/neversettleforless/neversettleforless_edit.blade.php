                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control textarea" class="form-control" placeholder="Enter Section Detail" id="section_detail" 
                        name="section_detail"><?php 
                        if(isset($dataRow->section_detail)){
                            ?>{{$dataRow->section_detail}}<?php 
                        }
                        ?></textarea>
                      </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Enter Section Image</label>
                                    <!-- <label for="customFile">Enter Section Image</label> -->
                                    <div class="custom-file">
                                      ...
                                      <label class="custom-file-label" for="customFile">Enter Section Image</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                @if(isset($dataRow->section_image))
                                    @if(!empty($dataRow->section_image))
                                        <img class="img-thumbnail" src="{{url('upload/neversettleforless/'.$dataRow->section_image)}}" width="150">
                                    @endif
                                @endif
                            </div>
                        </div>
